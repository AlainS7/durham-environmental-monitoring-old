...
spreadsheet.share('user@gmail.com', perm_type='user', role='writer')  # replace with your email
...
while True:
    try:
        ...
        start_dt_obj = datetime.fromisoformat(start_date_str)
        break
    except ValueError:
        print("❌ Invalid start date. Please enter a valid date like 2025-04-01")

while True:
    try:
        end_date_str = input('Enter end date (YYYY-MM-DD): ')
        end_dt_obj = datetime.fromisoformat(end_date_str)
        break
    except ValueError:
        print("❌ Invalid end date. Please enter a valid date like 2025-05-10")

start_dt = start_dt_obj.strftime('%Y-%m-%dT00:00:00Z')
end_dt = end_dt_obj.strftime('%Y-%m-%dT23:59:59Z')
...
for device in devices:
    ...
    summary_data.append([device_name, avg_pm25, max_temp, min_temp, avg_humidity])
